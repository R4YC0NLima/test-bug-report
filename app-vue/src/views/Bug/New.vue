                            ...
                            <div class="px-4 py-5 bg-white sm:p-6">
                                <div class="md:flex md:items-center mb-6">
                                    <div class="md:w-full">
                                        ...
                                        <input type="text" v-model="formData.title" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="inline-full-name">
                                    </div>
                                </div>
                                ...
                                <div class="md:flex md:items-center mb-6">
                                    <div class="md:w-full">
                                        ...
                                        <textarea v-model="formData.description" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="inline-password" type="password" placeholder="******************">
                                        </textarea>
                                    </div>
                                </div>
